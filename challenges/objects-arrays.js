...
console.log(dinoTrex.weight);

// What was the diet of a velociraptor?
console.log(dinoTrex.diet);

// How long was a stegosaurus?
console.log(dinoStego.length);

// What time period did tyrannosaurus live in?
console.log(dinoTrex.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(dinoTrex.speak());
...
const universities = graduates.map(unis => unis.university).sort();
...
graduates.forEach(function(currentValue) {
    let uniString = (`${currentValue.university}`)
    uni.push(uniString.includes('Uni'))
})
console.log(uni);
...
zooAnimals.forEach(function(currentValue) {
    let newName = `Name: ${currentValue.animal_name} Scientific: ${currentValue.scientific_name}`
